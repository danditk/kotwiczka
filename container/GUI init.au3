...
Global $Okno_Tworzenie_kotwiczki_1 = GUICreate("Program_name", 339, 150, 1087, 28)
GUISetFont(8, 400, 0, "Showcard Gothic")
GUISetBkColor(0x313131)
GUICtrlCreateLabel("$variable_Text_Box", 18, 16, 302, 58, BitOR($SS_CENTER,$SS_NOPREFIX))
GUICtrlSetFont(-1, 10, 800, 0, "Showcard Gothic")
GUICtrlSetColor(-1, 0x569557)
Global $Button_Ok = GUICtrlCreateButton("Ok", 124, 96, 91, 33)
GUICtrlSetFont(-1, 10, 800, 0, "Showcard Gothic")
GUICtrlSetColor(-1, 0xFFFFFF)
GUICtrlSetBkColor(-1, 0x569557)
GUICtrlSetCursor (-1, 0)
...
Global $Okno_Tworzenie_kotwiczki = GUICreate("Program_name", 416, 172, 1058, 199)
GUISetFont(8, 400, 0, "Showcard Gothic")
GUISetBkColor(0x313131)
...
Global $Okno_Tworzenie_kotwiczki_2 = GUICreate("Program_name", 326, 169, 400, 217)
GUISetFont(8, 400, 0, "Showcard Gothic")
GUISetBkColor(0x313131)
...
Global $Okno_Tworzenie_kotwiczki_3 = GUICreate("Program_name", 416, 177, 360, 420)
GUISetFont(8, 400, 0, "Showcard Gothic")
GUISetBkColor(0x313131)
