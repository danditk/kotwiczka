...
MSGBox_ok('Pamietaj' & @CRLF & 'o pamieci', 3, "Ale jaja")
...
Func MSGBox_KO()
	...
	Global $Okno_Tworzenie_kotwiczki = GUICreate("Program_name", 416, 172)
	GUISetFont(8, 400, 0, "Showcard Gothic")
	GUISetBkColor(0x313131)
...
Func MSGBox_yesno()
	...
	Global $Okno_Tworzenie_kotwiczki_2 = GUICreate($Program_name, 326, 169)
	GUISetFont(8, 400, 0, "Showcard Gothic")
	GUISetBkColor(0x313131)
...
Func MSGBox_NOYES()
	...
	Global $Okno_Tworzenie_kotwiczki_3 = GUICreate("Program_name", 416, 177)
	GUISetFont(8, 400, 0, "Showcard Gothic")
	GUISetBkColor(0x313131)
